  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex justify-end">
        <div className="inline-flex rounded-lg border border-mentat-border/30 bg-mentat-secondary/20 p-1">
          <button 
            onClick={() => setIsInTerminalMode(false)}
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-all duration-200 ${
              !isInTerminalMode 
                ? 'bg-mentat-secondary text-mentat-highlight shadow-sm' 
      ...
      <div className="flex-1 relative overflow-hidden border border-mentat-border bg-mentat-secondary/10 rounded-lg flex flex-col">
        ...
        <div className="flex-1 flex flex-col min-h-0">
          ...
          <div className="px-4 py-3 border-t border-mentat-border/30 bg-mentat-secondary/5 backdrop-blur-sm">
            <form 
